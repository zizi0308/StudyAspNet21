...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:HyperLink ID="LnkMicrosoft" runat="server" NavigateUrl="https://www.microsoft.com" Text="마이크로소프트" /><br />

            <asp:Image ID="ImgChange" runat="server" ImageUrl="~/images/ASP-NET-Banners-01.png" />
            <asp:Button ID="BtnChage" runat="server" OnClick="BtnChage_Click" Text="이미지변경" />
