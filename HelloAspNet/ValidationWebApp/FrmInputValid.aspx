    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RangeValidator ID="ValAge" runat="server" ControlToValidate="TxtAge" 
                ErrorMessage="나이는 1~150사이의 정수입니다." ForeColor="DarkRed" MinimumValue="1" MaximumValue="150" Type="Integer"
            ...
            <asp:CompareValidator ID="ValComprePassword" runat="server" ControlToValidate="TxtPassword"
